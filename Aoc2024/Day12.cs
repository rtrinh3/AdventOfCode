...
namespace Aoc2024
{
    ...
    public class Day12(string input) : IAocDay
    {
        ...
        // Fence is defined by the two plots separated by the fence. The constructor normalizes the order.
        public class Fence : IEquatable<Fence>
        {
            ...
            internal bool AreAdjacentAligned(Fence other)
            {
                ...
                if (this.IsHorizontal)
                {
                    ...
                    return this.A.Row == other.A.Row && Math.Abs(this.A.Col - other.A.Col) == 1;
                }
                else if (this.IsVertical)
                {
                    ...
                    return this.A.Col == other.A.Col && Math.Abs(this.A.Row - other.A.Row) == 1;
                }
                else
                {
        ...
        public string Part2()
        {
            ...
            foreach (var region in regionArea.Keys)
            {
                ...
                for (int i = 0; i < thisFence.Count; i++)
                {
                    for (int j = i + 1; j < thisFence.Count; j++)
                    {
                ...
                var sideCount = thisFence.Select(sides.Find).Distinct().Count();
