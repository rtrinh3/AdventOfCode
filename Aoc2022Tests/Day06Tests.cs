...
namespace Aoc2022.Tests
{
    ...
    public class Day06Tests
    {
        ...
        {
            var instance = new Day06(File.ReadAllText("inputs/day06-example3.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day06(File.ReadAllText("inputs/day06-example4.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day06(File.ReadAllText("inputs/day06-example5.txt"));
            var answer = instance.Part1();
