namespace Aoc2020.Tests
{
    ...
    public class Day04Tests
    {
        ...
        {
            var instance = new Day04(File.ReadAllText("inputs/day04-example1.txt"));
        ...
        {
            var instance = new Day04(File.ReadAllText("inputs/day04-example2.txt"));
        ...
        {
            var instance = new Day04(File.ReadAllText("inputs/day04-example3.txt"));
            var answer = instance.Part2();
