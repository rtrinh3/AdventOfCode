namespace Aoc2020.Tests
{
    ...
    public class Day13Tests
    {
        ...
        {
            var instance = new Day13(File.ReadAllText("inputs/day13-example1.txt"));
        ...
        {
            var instance = new Day13(File.ReadAllText("inputs/day13-example2.txt"));
            var answer = instance.Part2();
        ...
        {
            var instance = new Day13(File.ReadAllText("inputs/day13-example3.txt"));
            var answer = instance.Part2();
        ...
        {
            var instance = new Day13(File.ReadAllText("inputs/day13-example4.txt"));
            var answer = instance.Part2();
        ...
        {
            var instance = new Day13(File.ReadAllText("inputs/day13-example5.txt"));
            var answer = instance.Part2();
        ...
        {
            var instance = new Day13(File.ReadAllText("inputs/day13-example6.txt"));
            var answer = instance.Part2();
