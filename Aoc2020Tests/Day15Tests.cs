namespace Aoc2020.Tests
{
    ...
    public class Day15Tests
    {
        ...
        {
            var instance = new Day15(File.ReadAllText("inputs/day15-example1.txt"));
        ...
        {
            var instance = new Day15(File.ReadAllText("inputs/day15-example2.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day15(File.ReadAllText("inputs/day15-example3.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day15(File.ReadAllText("inputs/day15-example4.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day15(File.ReadAllText("inputs/day15-example5.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day15(File.ReadAllText("inputs/day15-example6.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day15(File.ReadAllText("inputs/day15-example7.txt"));
            var answer = instance.Part1();
