...
namespace Aoc2019.Tests
{
    ...
    public class Day14Tests
    {
        ...
        {
            var instance = new Day14(File.ReadAllText("day14-example3.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day14(File.ReadAllText("day14-example4.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day14(File.ReadAllText("day14-example5.txt"));
            var answer = instance.Part1();
