...
namespace Aoc2019.Tests
{
    ...
    public class Day18Tests
    {
        ...
        {
            var instance = new Day18(File.ReadAllText("inputs/day18-example1.txt"));
        ...
        {
            var instance = new Day18(File.ReadAllText("inputs/day18-example2.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day18(File.ReadAllText("inputs/day18-example3.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day18(File.ReadAllText("inputs/day18-example4.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day18(File.ReadAllText("inputs/day18-example5.txt"));
        ...
        {
            var instance = new Day18(File.ReadAllText("inputs/day18-example6.txt"));
            var answer = instance.Part2();
        ...
        {
            var instance = new Day18(File.ReadAllText("inputs/day18-example7.txt"));
            var answer = instance.Part2();
        ...
        {
            var instance = new Day18(File.ReadAllText("inputs/day18-example8.txt"));
            var answer = instance.Part2();
