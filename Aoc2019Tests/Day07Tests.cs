...
namespace Aoc2019.Tests
{
    ...
    public class Day07Tests
    {
        ...
        {
            var instance = new Day07(File.ReadAllText("day07-example3.txt"));
            var answer = instance.Part1();
        ...
        {
            var instance = new Day07(File.ReadAllText("day07-example4.txt"));
        ...
        {
            var instance = new Day07(File.ReadAllText("day07-example5.txt"));
            var answer = instance.Part2();
