...
public class Day09Tests
{
    ...
    {
        var instance = new Day09(File.ReadAllText("day09-example3.txt"));
        var answer = instance.Part1();
    ...
    {
        var instance = new Day09(File.ReadAllText("day09-example4.txt"));
        var answer = instance.Part1();
    ...
    {
        var instance = new Day09(File.ReadAllText("day09-example5.txt"));
        var answer = instance.Part1();
        Assert.AreEqual("6", answer);
    }
    [TestMethod()]
    ...
    {
        var instance = new Day09(File.ReadAllText("day09-example6.txt"));
        var answer = instance.Part1();
    ...
    {
        var instance = new Day09(File.ReadAllText("day09-example7.txt"));
        var answer = instance.Part2();
    ...
    {
        var instance = new Day09(File.ReadAllText("day09-example8.txt"));
        var answer = instance.Part2();
